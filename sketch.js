...
function draw() {
  ...
  if(gameState===START){
    ...
    textSize(30);
    fill("yellow");
    text("Press 's' key to start the game.",windowWidth/2-250,windowHeight/2+50);
    text("Movements : You can use left arrow key & right arrow key to move.",windowWidth/2-250,windowHeight/2+150);
    text("Jump : You can jump with the space key.",windowWidth/2-250,windowHeight/2+200);
 ...
 bunny.velocityY+=1;
  ...
  if(gameState===WIN){
    ...
    text("Press 'r' to restart the game.",windowWidth/2-10,windowHeight/2+50);
  }

  if(gameState===END){
    fill("blue");
    text("Press 'r' to restart the game.",windowWidth/2-100,windowHeight/2+50);
  }
